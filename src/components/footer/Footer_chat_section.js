...
const [attach, setAttach] = React.useState("");
  ...
  return (
    <div className="h-[64px] bg-[#1e2321] flex items-center px-4 shadow-sm grow-0 shrink-0">
        ...
        <input type="text" className="outline-none rounded-lg h-[40px] placeholder:text-white/50 text-[15px] px-4 w-full bg-[#0f1110] text-white/60" placeholder="Type a message" onChange={e => onEmojiClick(e.target.value)} value={inputStr}/>
        </div>
